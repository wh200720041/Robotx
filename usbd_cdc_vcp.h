...
void VCP_send_IMU_Multi(unsigned char IMU_Index,int16_t temp1,int16_t temp2,int16_t temp3);
void VCP_send_IMU_Single(unsigned char IMU_Index,int16_t temp);
void VCP_send_IMU_All(int16_t temp1,int16_t temp2,int16_t temp3,int16_t temp4,int16_t temp5,int16_t temp6,int16_t temp7,int16_t temp8,int16_t temp9);
